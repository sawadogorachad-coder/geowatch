...
const NEWS_CATEGORIES = {
  ...
  political:  ['élection','vote','président','premier ministre','coup','manifestation','opposition','régime','démocratie','autoritaire','référendum','constitution','parlement','assemblée','gouvernement','transition','transition','putsch','presidential','election','government','parliament','protest','demonstration','opposition','democracy','autocracy']
};
